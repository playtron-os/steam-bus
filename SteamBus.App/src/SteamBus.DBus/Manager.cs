...
class Manager : IManager
{
  ...
  public Manager(Connection connection, DepotConfigStore depotConfigStore, DepotConfigStore dependenciesStore, DisplayManager displayManager, INetworkManager networkManager)
  {
